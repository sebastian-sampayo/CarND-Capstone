...
if("FALSE" STREQUAL "TRUE")
  set(waypoint_updater_SOURCE_PREFIX /capstone/ros/src/waypoint_updater)
  set(waypoint_updater_DEVEL_PREFIX /capstone/ros/devel)
  ...
  set(waypoint_updater_INSTALL_PREFIX /capstone/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'waypoint_updater' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/capstone/ros/install/${idir}'.  Ask the maintainer 'yousuf <yousuf@todo.todo>' to fix it.")
    endif()
